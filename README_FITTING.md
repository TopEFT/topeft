...
Fake-tau SF extraction is documented separately in
[`analysis/topeft_run2/README_faketau_sf_fitter.md`](analysis/topeft_run2/README_faketau_sf_fitter.md);
this README remains focused on Combine and statistical fitting.
