...
def test_merged_mode_renders_1l_tau_cr_alias_outputs(tmp_path, monkeypatch):
    ...
    assert (tmp_path / "cr_1l_1tau" / "1l_1tau_CR_met.png").exists()
...
def test_merged_njets_preserves_empty_low_bins_for_1l_tau_cr(tmp_path, monkeypatch):
    ...
    assert not (tmp_path / "cr_1l_1tau_0j" / "1l_1tau_CR_0j_met.png").exists()
    assert not (tmp_path / "cr_1l_1tau_1j" / "1l_1tau_CR_1j_met.png").exists()
    assert (tmp_path / "cr_1l_1tau_2j" / "1l_1tau_CR_2j_met.png").exists()
