...
def isPresTau(pt, eta, dxy, dz, idDeepTau2017v2p1VSjet, idDeepTau2017v2p1VSe, idDeepTau2017v2p1VSmu, minpt=20.0):
    ...
    #return  (pt>minpt)&(abs(eta)<get_te_param("eta_t_cut"))&(abs(dxy)<get_te_param("dxy_tau_cut"))&(abs(dz)<get_te_param("dz_tau_cut"))&(idDeepTau2017v2p1VSjet>>4 & 1 ==1)&(idDeepTau2017v2p1VSe>>1 & 1 ==1)&(idDeepTau2017v2p1VSmu>>1 & 1 ==1)
