...
if __name__ == "__main__":
    ...
    if executor_name in ["work_queue", "taskvine"]:
        ...
        executor_args = {
            "manager_name": f"top26006-three-top-2018-{outname}",
            # find a port to run work queue in this range:
            "port": port,
            "debug_log": f"top26006_three_top_2018_{outname}_debug.log",
            "transactions_log": f"top26006_three_top_2018_{outname}_tr.log",
            "stats_log": f"top26006_three_top_2018_{outname}_stats.log",
            "tasks_accum_log": f"top26006_three_top_2018_{outname}_tasks.log",
