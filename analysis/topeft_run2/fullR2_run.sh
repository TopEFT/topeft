...
# OPTIONS="--skip-cr --do-systs -o $OUT_NAME -c 1 -s 50 -x futures " #--split-lep-flavor " # Add "--scenario tau_analysis" (and "--scenario fwd_analysis") to activate the tau and forward metadata bundles
