...
if __name__ == '__main__':
    ...
    parser.add_argument('--fwd_analysis',action='store_true', help = 'Add fwd channels')
    ...
    processor_instance = analysis_processor.AnalysisProcessor(samplesdict,wc_lst,hist_lst,ecut_threshold,do_errors,do_systs,split_lep_flavor,skip_sr,skip_cr,offZ_split,tau_h_analysis,fwd_analysis)
