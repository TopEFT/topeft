...
YEAR="2022EE"
TYPE="" #Central"
COMMIT="9b6bdfe+e8b95a5+086741e"
...
python make_cr_and_sr_plots.py -f /scratch365/apiccine/${YEAR}CRs${TYPE}_${COMMIT}_np.pkl.gz -o /scratch365/apiccine/run3plots -t -y 2022 -s -n test${YEAR}CRs${TYPE}_${COMMIT}
