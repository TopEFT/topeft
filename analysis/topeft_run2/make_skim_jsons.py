...
def main():
    ...
    parser.add_argument('--skim-postfix', default='',metavar='NAME', help='Postfix string to differentiate the skim json from the original, defaults to "_NDSkim"')
    ...
    for _,hdir in hadoop_dataset_dirs.items():
        ...
        json_name = os.path.split(matched_json_fp)[1]          # e.g. WZto3LNu-2Jets_2022.json
        stem, ext = os.path.splitext(json_name)                # stem=WZto3LNu-2Jets_2022, ext=.json
        tokens = stem.split("_")    
