...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        for syst_var in syst_var_list:
            ...
            #print("\n\n\n\n\n\n\n", syst_var)
            #print("before ApplyJetCorrections:", ak.to_list(cleanedJets.pt)) 
            ...
            #print("after ApplyJetCorrections:", ak.to_list(cleanedJets.pt)) 
            #print("cleanedJets fields", [field for field in cleanedJets.fields]) #if field.startswith("JER")])
            #print("\n\n\n\n\n\n\n")
