...
if __name__ == '__main__':
    ...
    if args.hist_list == ["ana"]:
        ...
        hist_lst = ["genphoton_pt","genlep_pt"]
    ...
    processor_instance = genProcessor_photon.AnalysisProcessor(samplesdict,wc_lst,hist_lst,ecut_threshold,do_errors,do_systs,split_lep_flavor,skip_sr,skip_cr)
    ...
    if executor == "work_queue":
        executor_args = {
            ...
            'extra_input_files': ["genProcessor_photon.py"],
