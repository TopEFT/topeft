...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, wc_names_lst=[], do_errors=False, dtype=np.float32):
        ...
        self._accumulator = {
            ...
            "SumOfWeights_renormUp_factDown": HistEFT(proc_axis, dense_axis, wc_names=wc_names_lst),
            "SumOfWeights_renormDown_factUp": HistEFT(proc_axis, dense_axis, wc_names=wc_names_lst),
        }
    ...
    def process(self, events):
        ...
        hout["SumOfWeights_renormDown_factUp"].fill(process=dataset,   SumOfWeights=counts, weight=wgts*events.renormDown_factUp,   eft_coeff=eft_coeffs, eft_err_coeff=eft_w2_coeffs)
        hout["SumOfWeights_renormUp_factDown"].fill(process=dataset, SumOfWeights=counts, weight=wgts*events.renormUp_factDown, eft_coeff=eft_coeffs, eft_err_coeff=eft_w2_coeffs)
