...
if __name__ == '__main__':
    ...
    parser.add_argument('--outname','-o'   , default='diboson', help = 'Name of the output file with histograms')
    ...
    processor_instance = diboson_njets.AnalysisProcessor(samplesdict)
