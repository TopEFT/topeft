...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        ph_fo['inL_LRCD'] = ph_fo.mediumPhoton_regL
        ph_fo['inR_LRCD'] = ph_fo.mediumPhoton_regR
        ph_fo['inC_LRCD'] = ph_fo.mediumPhoton_regC
        ph_fo['inD_LRCD'] = ph_fo.mediumPhoton_regD
        ...
        for syst_var in syst_var_list:
            ...
            te_es.categorizePhotonsInLRCD_kMC(events) #prompt_flag=False means we want non-prompt by default
            ...
            if not isData:
                ...
                #Revisit: Once we have the "good" ttgamma sample, we won't need to apply these correction factors.
            ...
            # AR/SR categories
            selections.add("isSR_2lOS_L_LRCD",    ( events.is2l_SR) & charge2l_0 & events.isL_LRCD & bmask_atleast1med)   #the isL_LRCD mask also has non-prompt photon mask baked in for MC
            selections.add("isAR_2lOS_R_LRCD",    ( events.is2l_SR) & charge2l_0 & events.isR_LRCD & bmask_atleast1med)   #the isR_LRCD mask also has non-prompt photon mask baked in for MC
            selections.add("isMR_2lOS_C_LRCD",    ( events.is2l_SR) & charge2l_0 & events.isC_LRCD & bmask_atleast0med)   #the isC_LRCD mask also has non-prompt photon mask baked in for MC
            selections.add("isMR_2lOS_D_LRCD",    ( events.is2l_SR) & charge2l_0 & events.isD_LRCD & bmask_atleast0med)   #the isD_LRCD mask also has non-prompt photon mask baked in for MC
            ...
            cat_dict = {
                "2los_AR" : {
                    "atleast_1j" : {
                        ...
                        "appl_lst"     : ["isSR_2lOS_L_LRCD","isAR_2lOS_R_LRCD"],
                    },
                },
                "2los_MR" : {
                    "atleast_1j" : {
                        ...
                        "lep_flav_lst" : ["ee","mm"],
                        "appl_lst"     : ["isMR_2lOS_C_LRCD","isMR_2lOS_D_LRCD"],
                    },
