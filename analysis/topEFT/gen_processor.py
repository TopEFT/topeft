...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        is_clean_jet = isClean(genjet, gen_e, drmin=0.4) & isClean(genjet, gen_m, drmin=0.4) & isClean(genjet, gen_t, drmin=0.4) & (genjet.pt > 30.0)
        ...
        for dense_axis_name, dense_axis_vals in dense_axis_dict.items():
            ...
            #isnotnone_mask = (ak.fill_none((dense_axis_vals != None),False) & nlep>=2)
