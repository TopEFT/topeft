...
parser.add_argument('--executor','-x'       , default='taskvine', help = 'Which executor to use (futures, iterative, or taskvine)')
...
parser.add_argument('--port'                , default='9123-9130', help = 'TaskVine manager port (PORT or PORT_MIN-PORT_MAX).')
...
parser.add_argument('--resource-monitor'    , default='measure', help = "TaskVine resource monitor setting ('none' to disable).")
parser.add_argument('--resources-mode'      , default='auto', help = 'TaskVine resources mode (for example auto).')
