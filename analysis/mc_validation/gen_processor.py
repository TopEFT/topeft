...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, wc_names_lst=[], hist_lst=None, ecut_threshold=None, do_errors=False, do_systematics=False, split_by_lepton_flavor=False, skip_signal_regions=False, skip_control_regions=False, dtype=np.float32):
        ...
        self._accumulator = {
            ...
            "invm_ttX"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([400, 410, 420, 450, 500, 550, 600, 650, 700, 750, 800, 900, 1000],  name="invm_ttX",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
            "invm_tX"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([200, 210, 220, 250, 300, 350, 400, 450, 500, 600, 700, 1000],  name="invm_tX",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
