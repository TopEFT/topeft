...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, wc_names_lst=[], hist_lst=None, ecut_threshold=None, do_errors=False, do_systematics=False, split_by_lepton_flavor=False, skip_signal_regions=False, skip_control_regions=False, dtype=np.float32):
        ...
        self._accumulator = {
            ...
            #"invm_ttX"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 2500, 3000, 4000],  name="invm_ttX",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
            "invm_ttX"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([300, 310, 320, 350, 400, 500, 700, 1000],  name="invm_ttX",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
            "invm_tX"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([200, 300, 310, 320, 350, 400, 500, 700, 1000],  name="invm_tX",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
            "invm_4t"          : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Variable([700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 2500, 3000, 4000],  name="invm_4t",        label=r"Invmass of system"), wc_names=wc_names_lst, rebin=False),
            ...
            "dral"    : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Regular(10,0,1, name="dral", label=r"$\Delta R(\gamma, \ell)$"), wc_names=wc_names_lst, rebin=False),
            ...
            "draj"    : HistEFT(proc_axis, chan_axis, syst_axis, appl_axis, hist.axis.Regular(10,0,1, name="draj", label=r"$\Delta R(\gamma, j)$"), wc_names=wc_names_lst, rebin=False),
    ...
    def process(self, events):
        ...
        gen_Z   = ak.pad_none(genpart[(abs(genpart.pdgId) == 23)],2)
        gen_H   = ak.pad_none(genpart[(abs(genpart.pdgId) == 25)],2)
